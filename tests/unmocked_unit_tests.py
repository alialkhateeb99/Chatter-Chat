'''
This file contains the testsfor
functions that dont require mocking
'''
...
class ChatRoomTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.success_test_check_message_image = [
            {
                KEY_INPUT: "https://www.extremetech.com/wp-content/uploads/ \
                2019/12/SONATA-hero-option2-764A4983-640x354.jpg",
                KEY_EXPECTED :
        ...
        self.failure_test_check_message_image = [
            {
                ...
                2019/12/SONATA-hero-option2-764A4983-640x354.jpg",
                KEY_EXPECTED :
                "https://www.extremetech.com/wp-content/uploads/ \
                2019/12/SONATA-hero-option2-764A4983-640x354.jpg"
            }
        ]
    ...
    def test_check_url_extension_success(self):
        ''' success function to check url extension '''
        for test in self.success_test_check_url_extension:
            response = botfunctions.check_url_extension(test[KEY_INPUT])
            expected = test[KEY_EXPECTED]
            self.assertEqual(response,expected)

    def test_check_url_extension_failure(self):
        ''' failure function to check url extension '''
    ...
    def test_check_message_image_success(self):
        ''' success function to check valid bot cmd '''
        for test in self.success_test_check_message_image:
            response = botfunctions.check_message_image(test[KEY_INPUT])
            expected = test[KEY_EXPECTED]

            self.assertEqual(response,expected)

    def test_check_message_image_failure(self):
        ''' failure function to check valid bot cmd '''
    ...
    def test_get_bot_info_success(self):
        ''' success function to return bot result '''
        for test in self.success_test_params_get_bot_info:
            response = botfunctions.get_bot_info(test[KEY_INPUT])
            expected = test[KEY_EXPECTED]
    ...
    def test_get_bot_info_failure(self):
        ''' failure function to return bot result '''
    ...
    def test_bot_command_helper_success(self):
        ''' success function to return helper bot results '''
    ...
    def test_bot_command_helper_failure(self):
        ''' failure function to return helper bot results '''
    ...
    def test_check_valid_bot_command_success(self):
        ...
        for test in self.success_test_check_valid_bot_command:
            response = botfunctions.check_valid_bot_command(test[KEY_INPUT])
            expected = test[KEY_EXPECTED]
            self.assertEqual(response,expected)
