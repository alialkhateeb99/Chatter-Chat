...
class ChatRoomTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.success_test_params_bot_command_helper = [
            {KEY_INPUT: "about", KEY_EXPECTED: "Hello! Welcome to Ali's chat room!"},
            {
                KEY_INPUT: "owner",
                KEY_EXPECTED: "Ali Alkhateeb is the owner of the site!!",
            },
            {
                KEY_INPUT: "help",
        ...
        self.failure_test_params_bot_command_helper = [
            {KEY_INPUT: "about", KEY_EXPECTED: "about"}
        ]
        self.success_test_check_message_image = [
            {
                ...
                KEY_EXPECTED: "<img src='https://www.extremetech.com/wp-content/uploads/2019/12/SONATA-hero-option2-764A4983-640x354.jpg' width='200' height='200' >",
            }
        ]
        self.failure_test_check_message_image = [
            {
                KEY_INPUT: "https://www.extremetech.com/wp-content/uploads/2019/12/SONATA-hero-option2-764A4983-640x354.jpg",
                KEY_EXPECTED: "https://www.extremetech.com/wp-content/uploads/2019/12/SONATA-hero-option2-764A4983-640x354.jpg",
            }
        ]
        ...
        self.success_test_check_valid_bot_command = [
            {KEY_INPUT: "!! help", KEY_EXPECTED: True},
            {KEY_INPUT: "!! HELP HELP !!", KEY_EXPECTED: True},
        ]
        self.failure_test_check_valid_bot_command = [
            {KEY_INPUT: "!! help", KEY_EXPECTED: False}
        ]
    ...
    def test_get_bot_info_failure(self):
        for test in self.failure_test_params_get_bot_info:
            ...
            self.assertNotEqual(
                response[KEY_IS_BOT_COMMAND], expected[KEY_IS_BOT_COMMAND]
            )
